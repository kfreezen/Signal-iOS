...
public class CVUtils {
    ...
    private static let workQueue_userInitiated: DispatchQueue = {
        DispatchQueue(label: "com.kentfriesen.signal.conversationView.workQueue_userInitiated",
                      qos: .userInitiated,
                      autoreleaseFrequency: .workItem)
    }()

    private static let workQueue_userInteractive: DispatchQueue = {
        DispatchQueue(label: "com.kentfriesen.signal.conversationView.workQueue_userInteractive",
                      qos: .userInteractive,
                      autoreleaseFrequency: .workItem)
    }()
    ...
    public static let landingQueue: DispatchQueue = {
        DispatchQueue(label: "com.kentfriesen.signal.conversationView.landingQueue",
                      qos: .userInitiated,
                      autoreleaseFrequency: .workItem)
    }()
}
